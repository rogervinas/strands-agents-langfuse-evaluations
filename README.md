...
`docker-compose-langfuse.yml` is the [official Langfuse self-hosted docker-compose](https://github.com/langfuse/langfuse/blob/main/docker-compose.yml), with no modifications.
